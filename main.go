...
func (t Training) distance() float64 {
	...
	disCovered := float64(t.Action) * t.LenStep / MInKm
	return disCovered
}
...
func (t Training) meanSpeed() float64 {
	...
	midSpeedRunOrWalk := t.distance() / t.Duration.Hours()
	return midSpeedRunOrWalk
}
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	spentCaloriesWhileRunning := ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) *
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	metresSec := w.meanSpeed() * KmHInMsec // скорость в метрах в секунду
	heightMetres := w.Height / CmInM       // рост в метрах
	spentCaloriesWhileWalking := ((CaloriesWeightMultiplier*w.Weight + (math.Pow(metresSec, 2)/heightMetres)*
...
func (s Swimming) meanSpeed() float64 {
	...
	midSpeedWhileSwimming := float64(s.LengthPool*s.CountPool) / MInKm / s.Duration.Hours()
	return midSpeedWhileSwimming
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	spentCaloriesWhileSwimming := ((s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier *
